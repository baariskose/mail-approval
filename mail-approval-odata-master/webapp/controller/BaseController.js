...
sap.ui.define([
	...
	return Controller.extend("workflow.approvals.com.bmc.controller.BaseController", {
		/**
		...
		_getBusyFragment: function () {
			if (!this._oBusyDialog) {
				this._oBusyDialog = sap.ui.xmlfragment("workflow.approvals.com.bmc.fragment.GenericBusyDialog", this);
